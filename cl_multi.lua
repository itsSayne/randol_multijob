                ...
                },
                {
                    ...
                    onSelect = function()
                        local confirm = lib.alertDialog({
                            header = 'Confirm Job Deletion',
                            content = ('Are you sure you want to delete **%s**?'):format(args.jobLabel),
                            centered = true,
                            cancel = true
                        })
                ...
                },
                {
                    ...
                    onSelect = function()
                        local confirm = lib.alertDialog({
                            ...
                            content = ('Are you sure you want to delete **%s**?'):format(args.gangLabel),
                            centered = true,
                            cancel = true
                        })
